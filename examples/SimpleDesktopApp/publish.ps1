...
.DESCRIPTION
    Publishes SimpleDesktopApp as a single-file executable with configurable options
...
Write-Host "  SimpleDesktopApp Configurable Publisher  " -ForegroundColor Cyan
Write-Host "===========================================" -ForegroundColor Cyan
Write-Host ""
...
$ExePath = Join-Path $OutputDir "SimpleDesktopApp.exe"
if (-not (Test-Path $ExePath)) {
    $ExePath = Join-Path $OutputDir "SimpleDesktopApp"
}
