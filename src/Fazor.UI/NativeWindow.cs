...
public class NativeWindow : INativeWindow, IDisposable
{
    ...
    public NativeWindow(int width = 1280, int height = 720, string title = "Fazor App", GraphicsBackendType? backendType = null, bool transparentFramebuffer = true, bool borderless = false)
    {
